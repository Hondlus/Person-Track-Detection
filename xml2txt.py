...
# VOC格式的文件的存放路径
path_voc = './zhuanhuan/Annotations/'
# Yolo格式的标注文件目标路径
path_yolo = './zhuanhuan/labels/'
# 类名文件的路径
...
for xml_fname in xml_fname_list:
    ...
    # 获取图像尺寸
    width = int(re.findall(wwidth, xml_file_content)[0]) + 0.01
    height = int(re.findall(hheight, xml_file_content)[0]) + 0.01
    # 获取矩形框左上角跟右下角的坐标
